...
const FeaturedServices = () => {
  const services = [
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer:
            "Valid passport, DS-160 form, visa fee payment, interview appointment, financial evidence, travel itinerary, ties to home country documentation.",
        },
      ],
    },
    {
  ...
  return (
    <section className="px-4 py-32 bg-secondary">
      <div className="section-container">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-blue-950/60 max-w-2xl mx-auto">
            Get answers to common questions about our most requested immigration
            services.
          </p>
        </div>
