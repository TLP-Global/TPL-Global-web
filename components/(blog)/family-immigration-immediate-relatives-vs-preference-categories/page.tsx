...
'family-immigration-immediate-relatives-vs-preference-categories': {
    ...
    content: {
      ...
      expertHelp: {
        ...
        description: 'founded TPL Global with a simple belief that immigration clients deserve both sharp legal strategy and genuine care. Known for his tenacity, creative problem-solving, and clear communication, Tejas has helped individuals and families navigate complex immigration challenges with confidence.'
      }
    }
  },
};
